...
const snippetBirthChart: TikTokScript = {
  ...
  scenes: [
    {
      description: 'Chart wheel animating in, all placements visible',
      path: '/birth-chart',
      durationSeconds: 3.5,
      action: 'show',
      focusPoint: 'Full birth chart wheel rendering with all celestial bodies',
      voiceoverLine:
        'Twenty-four placements. Not ten. Every asteroid, every node.',
      zoomTo: { x: 0.5, y: 0.42, scale: 1.15 },
    },
    {
      description: 'Zoom into a specific placement like Lilith or Chiron',
      path: '/birth-chart',
      durationSeconds: 2.5,
      action: 'scroll',
      scrollDistance: 350,
      focusPoint: 'Chiron or Lilith placement with sign and house',
      voiceoverLine: 'Chiron in the sixth house. That explains a lot.',
      zoomTo: { x: 0.5, y: 0.55, scale: 1.35 },
    },
    {
      description: 'Hold on the chart overview',
      path: '/birth-chart',
      durationSeconds: 1.5,
      action: 'show',
      focusPoint: 'Full chart visible, letting the viewer absorb it',
      voiceoverLine: 'Yeah. That tracks.',
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    'Twenty-four placements. Not ten. Every asteroid, every node. Chiron in the sixth house. That explains a lot. Yeah. That tracks.',
  textOverlays: [
    {
...
const snippetCompatibility: TikTokScript = {
  ...
  scenes: [
    {
      ...
      voiceoverLine: 'So I ran our charts through synastry and... oh.',
      zoomTo: { x: 0.5, y: 0.38, scale: 1.2 },
    },
    {
    ...
    },
    {
      ...
      voiceoverLine: 'Should I tell them or...',
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    'So I ran our charts through synastry and... oh. Venus square Mars. That explains the tension. Should I tell them or...',
  textOverlays: [
    {
      text: 'synastry says...',
      startSeconds: 2,
...
const snippetAngelNumber: TikTokScript = {
  ...
  scenes: [
    {
      description: 'Grimoire search loading with 444 angel number result',
      path: '/grimoire',
      durationSeconds: 3,
      action: 'type',
      ...
      voiceoverLine: "It's not random. Your guides are confirming the path.",
    },
    {
      description: 'Scroll to the key insight in the article',
      path: '/grimoire',
      durationSeconds: 3,
      action: 'scroll',
      scrollDistance: 300,
      focusPoint: 'The core meaning of 444: protection, foundation',
      voiceoverLine: 'Protection. Foundations are solid. Keep building.',
      zoomTo: { x: 0.5, y: 0.5, scale: 1.25 },
    },
    {
      description: 'Hold on the key line',
      path: '/grimoire',
      durationSeconds: 1.5,
      action: 'show',
  ...
  voiceover:
    "It's not random. Your guides are confirming the path. Protection. Foundations are solid. Keep building. Save this.",
  textOverlays: [
    {
  ...
  caption:
    'If 444 keeps showing up, here is what your guides are telling you. What number do you keep seeing?',
...
const snippetTransitAlert: TikTokScript = {
  ...
  totalSeconds: 11.5,
  hook: {
    text: 'Mercury stations direct tomorrow',
    durationSeconds: 2,
  },
  scenes: [
    {
      description: 'Transit tracker showing Mercury position and status',
      path: '/sky',
      durationSeconds: 3.5,
      action: 'show',
      focusPoint: 'Mercury highlighted in the transit view with status',
      voiceoverLine:
        'Mercury goes direct and whatever you have been holding back? Green light.',
      zoomTo: { x: 0.5, y: 0.4, scale: 1.2 },
    },
    {
      description: 'Zoom into the house Mercury is transiting',
      path: '/sky',
      durationSeconds: 2.5,
      action: 'scroll',
      scrollDistance: 200,
      focusPoint: 'Which house Mercury is activating for the user',
      voiceoverLine: 'Check which house it hits in your chart.',
      zoomTo: { x: 0.5, y: 0.55, scale: 1.3 },
    },
    {
      ...
      durationSeconds: 2,
      action: 'show',
      focusPoint: 'Personal implication visible',
      voiceoverLine: "That's where the shift lands.",
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    "Mercury goes direct and whatever you have been holding back? Green light. Check which house it hits in your chart. That's where the shift lands.",
  textOverlays: [
    {
  ...
  caption:
    'Mercury stations direct tomorrow. Check which house it activates in your chart because that is where everything unsticks.',
  hashtags: [
    'mercuryretrograde',
    'mercurydirect',
    'astrology',
...
const snippetTarotPull: TikTokScript = {
  ...
  scenes: [
    {
      ...
      voiceoverLine: 'One card. The Tower. Okay then.',
      zoomTo: { x: 0.5, y: 0.4, scale: 1.2 },
    },
    {
      ...
      voiceoverLine:
        'Connected to Pluto transiting my tenth house. Career shake-up.',
      zoomTo: { x: 0.5, y: 0.52, scale: 1.25 },
    },
    {
  ...
  voiceover:
    'One card. The Tower. Okay then. Connected to Pluto transiting my tenth house. Career shake-up. Not what I wanted to hear.',
  textOverlays: [
    {
...
const snippetHoroscopeSpeed: TikTokScript = {
  ...
  scenes: [
    {
      ...
      voiceoverLine:
        'Career peak mid-month. Relationship tension around the 18th.',
    },
    {
      ...
      voiceoverLine: 'But the 25th? That is your window. Do not miss it.',
      zoomTo: { x: 0.5, y: 0.48, scale: 1.3 },
    },
    {
      ...
      voiceoverLine: 'Save this. You will need it.',
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    'Career peak mid-month. Relationship tension around the 18th. But the 25th? That is your window. Do not miss it. Save this. You will need it.',
  textOverlays: [
    {
...
const snippetAstralChat: TikTokScript = {
  ...
  totalSeconds: 12,
  hook: {
    text: 'This is not AI. It is 2,000 articles.',
    durationSeconds: 2,
  },
  scenes: [
    {
      ...
      voiceoverLine:
        'I asked about my Saturn return. It pulled from the grimoire.',
    },
    {
      ...
      voiceoverLine:
        'Specific houses. Real degrees. Two thousand articles behind every answer.',
      zoomTo: { x: 0.5, y: 0.55, scale: 1.25 },
    },
    {
  ...
  voiceover:
    'I asked about my Saturn return. It pulled from the grimoire. Specific houses. Real degrees. Two thousand articles behind every answer. It knew.',
  textOverlays: [
    {
...
const snippetCosmicScore: TikTokScript = {
  ...
  totalSeconds: 11.5,
  hook: {
    text: 'My cosmic score tanked. Here is why.',
    durationSeconds: 2,
  },
  scenes: [
    {
      ...
      voiceoverLine: 'Cosmic score dropped to 3.8. Something shifted.',
      zoomTo: { x: 0.5, y: 0.35, scale: 1.2 },
    },
    {
      ...
      voiceoverLine: 'Twelve pattern types. Nobody else tracks this.',
      zoomTo: { x: 0.5, y: 0.5, scale: 1.25 },
    },
    {
      ...
      voiceoverLine: 'Now I know why the week felt off.',
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    'Cosmic score dropped to 3.8. Something shifted. Twelve pattern types. Nobody else tracks this. Now I know why the week felt off.',
  textOverlays: [
    {
  ...
  caption:
    'My cosmic score tanked and the pattern breakdown explained everything. What is your cosmic score today?',
...
const snippetRealAstronomy: TikTokScript = {
  ...
  totalSeconds: 11.5,
  hook: {
    text: 'Your astrology app guesses. This calculates.',
    durationSeconds: 2,
  },
  scenes: [
    {
      ...
      voiceoverLine: 'Real VSOP87 calculations. Plus or minus one arcminute.',
      zoomTo: { x: 0.5, y: 0.4, scale: 1.25 },
    },
    {
      ...
      voiceoverLine: 'Every planet. Exact position. Calculated, not copied.',
      zoomTo: { x: 0.5, y: 0.52, scale: 1.3 },
    },
    {
      ...
      voiceoverLine: 'The sky does not lie.',
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    'Real VSOP87 calculations. Plus or minus one arcminute. Every planet. Exact position. Calculated, not copied. The sky does not lie.',
  textOverlays: [
    {
...
const snippetMoonSpells: TikTokScript = {
  ...
  title: '112 spells filtered by tonight is moon',
  tier: 1,
  category: 'snippet',
  totalSeconds: 11.5,
  hook: {
    text: '112 spells. Filtered by tonight is moon.',
    durationSeconds: 2,
  },
  scenes: [
    {
      ...
      voiceoverLine:
        'One hundred and twelve spells. Filtered by the moon right now.',
      zoomTo: { x: 0.5, y: 0.4, scale: 1.15 },
    },
    {
      ...
      voiceoverLine: 'Different moon, different spells. Changes every night.',
      zoomTo: { x: 0.5, y: 0.5, scale: 1.2 },
    },
    {
  ...
  voiceover:
    'One hundred and twelve spells. Filtered by the moon right now. Different moon, different spells. Changes every night. Which one are you casting?',
  textOverlays: [
    {
  ...
  caption:
    'One hundred and twelve spells, filtered by tonight is moon phase. Different moon, different magic. Which spell are you casting tonight?',
...
const snippetCircleFriends: TikTokScript = {
  ...
  scenes: [
    ...
    {
      description: 'Tap into a friend to see aspect highlights',
      path: '/profile',
      durationSeconds: 3,
      action: 'click',
      target: '[data-testid="friend-card"]',
      focusPoint: 'Synastry aspects between the two charts',
      voiceoverLine: 'Thirty-six aspects mapped. The tension? Explained.',
      zoomTo: { x: 0.5, y: 0.5, scale: 1.25 },
      tapPosition: { x: 0.5, y: 0.4 },
    },
    {
      ...
      voiceoverLine: 'Now she gets why I am like this.',
    },
  ],
  outro: {
    text: 'lunary.app',
  ...
  voiceover:
    'Your friend group as birth charts. Side by side. Thirty-six aspects mapped. The tension? Explained. Now she gets why I am like this.',
  textOverlays: [
    {
...
const snippetTarotTransits: TikTokScript = {
  ...
  scenes: [
    ...
    },
    {
      ...
      voiceoverLine:
        'The transit connection showed exactly why. No other app does this.',
      zoomTo: { x: 0.5, y: 0.55, scale: 1.3 },
    },
    {
  ...
  voiceover:
    'Pulled the Tower during Pluto square my Moon. The transit connection showed exactly why. No other app does this. Coincidence? No.',
  textOverlays: [
    {
