...
const TAROT_PACK_CONFIGS: TarotPackConfig[] = [
  {
    ...
    perfectFor: [
      ...
      'Processing difficult emotions through cards',
      'Jungian-inspired inner work',
    ],
  ...
  },
  {
    ...
    perfectFor: [
      ...
      'Manifesting professional abundance',
  ...
  },
  {
    ...
    perfectFor: [
      'Deepening tarot practice through elements',
      'Understanding the suits more intimately',
      'Balancing personality and energy',
    ],
    price: PRICE_TIERS.tarot,
...
const SUIT_PACK_CONFIGS: TarotPackConfig[] = [
  {
    ...
    perfectFor: [
      'Understanding fire energy in tarot',
      'Boosting creativity and motivation',
      'Deep-diving into Wands meanings',
    ],
    price: PRICE_TIERS.tarot,
  ...
  },
  {
    ...
    perfectFor: [
      'Understanding water energy in tarot',
  ...
  },
  {
    ...
    perfectFor: [
      'Understanding air energy in tarot',
  ...
  },
  {
    ...
    perfectFor: [
      'Understanding earth energy in tarot',
...
const MAJOR_ARCANA_CONFIG: TarotPackConfig[] = [
  {
    ...
    perfectFor: [
      'Deep Major Arcana study',
      "Understanding life's bigger patterns",
      'Soul-level guidance and purpose',
    ],
    price: PRICE_TIERS.tarotPremium,
