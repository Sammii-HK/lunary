...
function buildAstrologySection(
  ...
  // Section title (wrap if too long)
...
export async function generateAstrologyPackPdf(
  ...
  closing.drawText('After your exploration', {
    x: MARGIN,
    y,
  ...
  const affirmation =
    ...
    'I align with the cosmic rhythms. The stars offer guidance, and I trust my own unfolding.';
