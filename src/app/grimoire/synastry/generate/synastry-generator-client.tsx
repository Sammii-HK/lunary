          ...
          <Star
            ...
            className={`w-4 h-4 ${
              i < Math.round(score / 20)
                ? 'text-lunary-accent fill-lunary-accent'
                : 'text-zinc-700'
            }`}
          />
        ))}
...
export default function SynastryGeneratorClient() {
  const { user } = useUser();
    ...
    return (
      <div className='text-center py-12'>
        ...
        <p className='text-zinc-400 mb-8 max-w-md mx-auto'>
          Compare two birth charts to discover compatibility, strengths, and
          growth areas. Available for Lunary subscribers.
        </p>
  ...
  return (
    <>
      <section id='input-charts' className='mb-8'>
      ...
      {result && (
        <section id='synastry-summary' className='space-y-8'>
          ...
          <section id='key-aspects' className='space-y-4'>
            <h2 className='text-2xl font-medium text-zinc-100'>Key Aspects</h2>
