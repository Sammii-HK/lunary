...
export default async function MoonInSignPage({
  ...
  const elementDescriptions: Record<string, string> = {
    ...
    Earth: 'Earth moons are practical, grounded, and stable. Emotions are expressed through tangible actions and material security.',
    ...
    Water: 'Water moons are emotional, intuitive, and deeply feeling. Emotions flow naturally and are expressed with sensitivity.',
  };
