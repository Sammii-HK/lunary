...
export default function CrystalsPage() {
  ...
  const tableOfContents = [
    { label: '1. How Crystals Work', href: '#how-crystals-work' },
    { label: '2. Choosing Your Crystals', href: '#choosing' },
    { label: '3. Cleansing & Charging', href: '#cleansing' },
    { label: '4. Working with Crystals', href: '#working-with' },
    { label: "5. Beginner's Starter Kit", href: '#starter-kit' },
    { label: '6. Crystals A-Z', href: '#all-crystals' },
    { label: '7. FAQ', href: '#faq' },
  ];
  ...
  return (
    <>
      ...
      <SEOContentTemplate
        ...
        h1='Crystals'
        description='Complete guide to crystals and their meanings. Learn how to choose, cleanse, and work with crystals for healing, protection, and magical practice.'
        ...
        intro='Crystals are powerful allies for healing, protection, and magical work. Each stone carries unique vibrational properties that can support your intentions, balance energy, and amplify your practice. This guide covers how to choose, cleanse, and work with crystals effectively.'
        meaning='Crystals form within the Earth over millions of years. Their molecular structures create frequencies that interact with human energy, providing focus, amplification, and symbolic reminders for magical practitioners.'
        tableOfContents={tableOfContents}
        whatIs={{
          question: 'How do crystals support magical practice?',
          answer:
            'Crystals serve as ritual tools, focus points, and energy amplifiers. Their presence helps channel intention, anchor goals, and open pathways for intuition and healing.',
        }}
        howToWorkWith={[
          'Choose crystals with intuition, intention, or chakra alignment',
          'Cleanse with moonlight, water, salt, smoke, sound, or selenite',
          'Charge crystals by stating intention and visualizing energy transfer',
          'Carry, wear, place, or lattice crystals to keep energy anchored',
          'Combine crystals with spells, rituals, grids, and altar layouts',
        ]}
        faqs={faqs}
        cosmicConnections={
          <CosmicConnections
        ...
        relatedItems={[
          {
            name: 'Magical Correspondences',
            href: '/grimoire/correspondences',
            type: 'Elements, herbs, colors, and planetary links',
          },
          {
            name: 'Protection Magic',
            href: '/grimoire/protection',
            type: 'Crystals for shielding and grounding',
          },
          {
            name: 'Chakra Guide',
            href: '/grimoire/chakras',
            type: 'Align crystals with energy centers',
          },
          {
            name: 'Meditation Techniques',
            href: '/grimoire/meditation',
            type: 'Use stones to amplify stillness',
          },
        ]}
        internalLinks={[
        ...
        ctaText='Need a tailored crystal stack for your next ritual?'
        ctaHref='/pricing'
      >
        <section id='how-crystals-work' className='mb-16'>
          ...
          <ul className='space-y-2 text-zinc-300 mb-6'>
            ...
            <li>
              • <strong>Energy amplifiers:</strong> They can intensify the
              energy you direct
            </li>
          </ul>
          ...
          <div className='bg-zinc-900/50 border border-zinc-800 rounded-xl p-6'>
            <p className='text-zinc-400 text-sm'>
              Whether you see crystals as having inherent metaphysical
              properties or as psychological tools, they can be valuable allies
              in your practice. Their beauty and earth-born nature connect you
        ...
        <section id='choosing' className='mb-16'>
          ...
          <div className='space-y-4'>
            <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
              ...
              <p className='text-zinc-400 text-sm'>
                Which crystal catches your eye? Which do you feel drawn to
                touch? Trust that pull—your subconscious often knows what you
                need.
              </p>
            </div>
            <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
              ...
              <p className='text-zinc-400 text-sm'>
                Research which crystals correspond to your goal. Need
                protection? Consider black tourmaline. Seeking love? Try rose
                quartz. Manifesting? Look to citrine.
              </p>
            </div>
            <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
        ...
        <section id='cleansing' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            ...
            Cleansing clears this accumulated energy; charging programs them
            with your intention.
          </p>
          ...
          <div className='bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 mb-6'>
            ...
            <ul className='space-y-2 text-zinc-400 text-sm'>
              <li>
                <strong className='text-zinc-200'>Moonlight:</strong> Leave
                under the Full Moon overnight (safe for all crystals)
              </li>
              <li>
                <strong className='text-zinc-200'>Running water:</strong> Hold
                under a stream for a minute (not for soft or water-soluble
                stones)
              </li>
              <li>
                <strong className='text-zinc-200'>Salt:</strong> Bury in sea
                salt for 24 hours (not for porous stones)
              </li>
              <li>
        ...
        <section id='working-with' className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
              ...
              <p className='text-zinc-400 text-sm'>
                Crystal jewelry keeps the stone in contact with your energy
                field all day. Pendants near the heart are especially powerful.
              </p>
            </div>
            <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
              ...
              <p className='text-zinc-400 text-sm'>
                Hold a crystal during meditation or place it on a relevant
                chakra. Focus on its energy and let impressions arise.
              </p>
            </div>
            <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
