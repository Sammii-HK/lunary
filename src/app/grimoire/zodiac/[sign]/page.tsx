...
export default async function ZodiacSignPage({
  ...
  const elementDescriptions: Record<string, string> = {
    ...
    Earth: 'Earth signs are practical, grounded, and reliable. They value stability, material security, and tangible results.',
    Air: 'Air signs are intellectual, communicative, and social. They thrive on ideas, communication, and mental stimulation.',
    Water: 'Water signs are emotional, intuitive, and deeply feeling. They are connected to their emotions, intuition, and the subconscious.',
  };

  const qualityDescriptions: Record<string, string> = {
    Cardinal: 'Cardinal signs initiate action and are natural leaders. They start new projects and take charge.',
    Fixed: 'Fixed signs are stable, determined, and persistent. They see things through to completion.',
    Mutable: 'Mutable signs are adaptable, flexible, and versatile. They can adjust to changing circumstances.',
  };
