    ...
    <div className='p-4 md:p-8 max-w-4xl mx-auto'>
      ...
      <section id='structure' className='mb-16'>
        ...
        <div className='bg-surface-elevated/50 border border-stroke-subtle rounded-xl p-6'>
          ...
          <ul className='space-y-2 text-content-muted text-sm'>
            <li>
              <strong className='text-content-primary'>Base:</strong> Salt
              (protection), sugar (sweetening), soil (grounding), rice
              (abundance)
            </li>
            <li>
              <strong className='text-content-primary'>Herbs:</strong> Dried
              herbs matching your intention
            </li>
            <li>
              <strong className='text-content-primary'>Crystals:</strong> Small
              tumbled stones or chips
            </li>
            <li>
              <strong className='text-content-primary'>Personal items:</strong>{' '}
              Hair, nails (for personal spells), photos, names written on paper
            </li>
            <li>
              <strong className='text-content-primary'>Binding agent:</strong>{' '}
              Honey (sweetening), oil (anointing), moon water
            </li>
            <li>
              <strong className='text-content-primary'>Seal:</strong> Wax from a
              candle matching your intention
            </li>
          </ul>
        </div>
      </section>
      ...
      <section id='ingredients' className='mb-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div className='p-5 rounded-xl border border-stroke-subtle bg-surface-elevated/30'>
            <h3 className='font-medium text-content-primary mb-2'>Banishing</h3>
            <p className='text-content-muted text-sm'>
      ...
      <section id='charging' className='mb-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div className='p-5 rounded-xl border border-stroke-subtle bg-surface-elevated/30'>
            <h3 className='font-medium text-content-primary mb-2'>Shaking</h3>
            <p className='text-content-muted text-sm'>
      ...
      <section id='examples' className='mb-16'>
        ...
        <div className='space-y-6'>
          <div className='bg-surface-elevated/50 border border-stroke-subtle rounded-xl p-6'>
            ...
            <ul className='text-content-muted text-sm space-y-1 mb-3'>
      ...
      <section id='disposal' className='mb-16'>
        ...
        <div className='bg-surface-elevated/50 border border-stroke-subtle rounded-xl p-6'>
          ...
          <ul className='space-y-2 text-content-muted text-sm'>
            <li>
              <strong className='text-content-primary'>When to dispose:</strong>{' '}
              When the spell has manifested, feels complete, or the jar breaks.
            </li>
            <li>
              <strong className='text-content-primary'>Thank the jar:</strong>{' '}
              Express gratitude for its work before opening.
            </li>
            <li>
            ...
            <li>
              ...
              Cleanse thoroughly and reuse or return to nature.
            </li>
            <li>
              <strong className='text-content-primary'>Glass jar:</strong>{' '}
              Cleanse and repurpose, or recycle.
            </li>
            <li>
              <strong className='text-content-primary'>Banishing jars:</strong>{' '}
              Dispose away from your home; throw in running water or bury at a
              crossroads.
            </li>
          </ul>
        </div>
