...
const GUIDE_CANONICAL = 'https://lunary.app/grimoire/guides/moon-phases-guide';
...
const HERO_INTRO =
  'Master the moon phases with our comprehensive guide. Learn the meaning of each lunar phase, moon rituals, manifestation timing, and how to align your life with the lunar cycle.';
const HERO_SUBTITLE = 'Lunar Cycles & Rituals';
...
export default function MoonPhasesGuidePage() {
  ...
  return (
    <>
      ...
      <SEOContentTemplate
        title='Moon Phases: The Complete Guide to Lunar Cycles & Rituals'
        h1='Moon Phases: The Complete Guide to Lunar Cycles & Rituals'
        description={GUIDE_DESCRIPTION}
        keywords={GUIDE_KEYWORDS}
        ...
        tableOfContents={[
          {
            label: 'Understanding the Lunar Cycle',
            href: '#understanding-moon',
          },
          { label: 'The 8 Moon Phases', href: '#eight-phases' },
          { label: 'Full Moon Names', href: '#full-moon-names' },
          { label: 'New Moon Ritual', href: '#new-moon-ritual' },
          { label: 'Full Moon Ritual', href: '#full-moon-ritual' },
          { label: 'Manifestation & the Moon', href: '#manifestation' },
          { label: 'Moon Signs', href: '#moon-signs' },
          { label: 'Special Moons', href: '#special-moons' },
          { label: 'FAQ', href: '#faq' },
        ]}
        faqs={faqs}
        cosmicConnections={
      ...
      >
        ...
        <section id='understanding-moon' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            ...
            has been tracked by humans since ancient times and forms the basis
            of many calendars and spiritual practices.
          </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <p className='text-zinc-400 text-sm'>
                  New Moon → Full Moon. The light increases. Energy for:
                  building, growing, attracting, creating, starting new things.
                </p>
              </div>
              <div>
                <h4 className='text-zinc-100 font-medium mb-2'>
        ...
        <section id='full-moon-names' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            ...
            from Native American, Colonial American, or European traditions.
            These names reflect the natural world and seasonal activities.
          </p>
        ...
        <section id='full-moon-ritual' className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
              ...
              <p className='text-zinc-400 text-sm'>
                Place your crystals outside or on a windowsill to absorb the
                Full Moon&apos;s energy overnight. Set an intention for each
                crystal.
              </p>
            </div>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
          ...
          <div className='space-y-4'>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-2'>
                ...
                Moon&apos;s closest approach to Earth (perigee). The Moon
                appears up to 14% larger and 30% brighter.
              </p>
              <p className='text-zinc-400 text-sm'>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-2'>
                A Solar Eclipse occurs when the Moon passes between Earth and
                the Sun, temporarily blocking sunlight. These are powerful New
                Moons that can mark major new beginnings.
              </p>
              <p className='text-zinc-400 text-sm'>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-2'>
                A Lunar Eclipse occurs when Earth passes between the Sun and
                Moon, casting a shadow on the Moon. These are intense Full Moons
                that often bring revelations and endings.
              </p>
              <p className='text-zinc-400 text-sm'>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-2'>
                ...
                occurring roughly every 2.5 years. Despite the name, the Moon
          ...
          <div className='space-y-4'>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
              ...
              <p className='text-zinc-400'>
                ...
                energy is perfect for new beginnings and clarifying what you
                want.
              </p>
            </div>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
              ...
              <p className='text-zinc-400'>
                Build momentum. Take concrete steps toward your goals. This is
                the time for active manifestation—doing, creating, and
                attracting.
              </p>
            </div>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
        ...
        <section id='moon-signs' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            As the Moon moves through each zodiac sign (about 2.5 days per
            sign), it takes on that sign&apos;s qualities. Knowing the current
            Moon sign helps you choose the best times for different activities.
          </p>
