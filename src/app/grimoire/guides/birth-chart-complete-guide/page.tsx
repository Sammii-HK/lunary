...
const HERO_INTRO =
  'Your birth chart is a cosmic snapshot of the sky at the exact moment you were born. This comprehensive guide will teach you everything you need to know about reading and interpreting your natal chart—from the basics to advanced techniques.';
  ...
  return (
    <>
      ...
      <SEOContentTemplate
        ...
        h1='Birth Chart: The Complete Guide'
        description={GUIDE_DESCRIPTION}
        keywords={GUIDE_KEYWORDS}
        ...
        tableOfContents={[
          { label: 'What is a Birth Chart?', href: '#what-is-birth-chart' },
          {
            label: 'How to Calculate Your Birth Chart',
            href: '#calculating-chart',
          },
          { label: 'The Big Three', href: '#big-three' },
          { label: 'Understanding the Planets', href: '#planets' },
          { label: 'The 12 Zodiac Signs', href: '#zodiac-signs' },
          { label: 'The 12 Houses', href: '#houses' },
          { label: 'Understanding Aspects', href: '#aspects' },
          { label: 'How to Read Your Chart', href: '#reading-chart' },
          { label: 'Advanced Techniques', href: '#advanced' },
          {
            label: 'How Lunary Uses Your Chart',
      ...
      >
        ...
        <section id='what-is-birth-chart' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            Think of your birth chart as your cosmic DNA—a unique fingerprint
            that no one else in the world shares (unless they were born at the
            exact same time, in the exact same place). This celestial snapshot
            provides insights into your personality, strengths, challenges,
            relationships, career path, and life purpose.
          </p>
          ...
          <div className='space-y-6'>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-4'>
                ...
                &quot;what&apos;s your sign?&quot; they&apos;re asking about
                your Sun sign. The Sun shows who you are at your core, your
                vitality, and the themes you&apos;re meant to explore in this
                lifetime.
              </p>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-4'>
                ...
                The Moon shows your private self—the person only those closest
                to you truly know.
              </p>
              <p className='text-zinc-400 text-sm'>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-6'>
              ...
              <p className='text-zinc-300 mb-4'>
                ...
                world—your first impression, appearance, and how you approach
                new situations. It&apos;s the sign that was rising on the
                eastern horizon at your moment of birth. The Rising sign also
                determines your chart ruler and the sign on each house cusp.
              </p>
              <p className='text-zinc-400 text-sm'>
        ...
        <section id='planets' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            Each planet represents a different aspect of your personality and
            life experience. Understanding what each planet signifies helps you
        ...
        <section id='aspects' className='mb-16'>
          ...
          <p className='text-zinc-300 leading-relaxed mb-6'>
            Aspects are the angles formed between planets, revealing how
            different parts of your chart interact—either harmoniously or with
            tension.
          </p>
        ...
        <section id='how-lunary-uses-chart' className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-6'>
            ...
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
              ...
              <p className='text-zinc-400 text-sm'>
                Receive notifications when significant planetary transits
                activate important points in your birth chart.
              </p>
            </div>
            <div className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
              <h4 className='text-lg font-medium text-zinc-100 mb-2'>
        ...
        <section className='bg-gradient-to-r from-lunary-primary-900/30 to-lunary-rose-900/30 border border-lunary-primary-700 rounded-xl p-8 text-center'>
          ...
          <p className='text-zinc-400 mb-6 max-w-xl mx-auto'>
            ...
            every placement. Lunary subscribers unlock full access to their
            cosmic blueprint—including personality insights, relationship
            patterns, and life path guidance.
          </p>
