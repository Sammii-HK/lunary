            ...
            {wheelOfTheYearSabbats.map((sabbat) => (
              ...
              >
                <div className='flex items-center justify-between mb-3'>
                  <h3 className='text-lg font-medium text-content-primary group-hover:text-amber-300 transition-colors'>
                    {sabbat.name}
                  </h3>
        ...
        <section className='mb-12'>
          ...
          <div className='space-y-4'>
            {faqs.map((faq, index) => (
              <div
                key={index}
                className='p-5 rounded-lg border border-stroke-subtle bg-surface-elevated/30'
              >
                <h3 className='text-lg font-medium text-content-primary mb-2'>
                  {faq.question}
                </h3>
                <p className='text-content-muted text-sm'>{faq.answer}</p>
              </div>
            ))}
          </div>
        </section>
