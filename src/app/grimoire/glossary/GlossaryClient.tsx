...
const GRIMOIRE_PAGE_LINKS: Record<string, string> = {
  ...
  house: '/grimoire/houses',
  'angular-house': '/grimoire/houses',
  'succedent-house': '/grimoire/houses',
  'cadent-house': '/grimoire/houses',
  ...
  midheaven: '/grimoire/houses/10th-house',
  ic: '/grimoire/houses/4th-house',
  ascendant: '/grimoire/houses/1st-house',
  descendant: '/grimoire/houses/7th-house',
