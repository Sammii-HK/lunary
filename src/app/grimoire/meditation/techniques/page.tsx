          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            {meditationTechniques.map((technique) => (
              <Link
                ...
                className='group rounded-xl border border-stroke-subtle bg-surface-elevated/30 p-5 hover:bg-surface-elevated/50 hover:border-indigo-700/50 transition-all'
              >
                ...
                <h3 className='text-lg font-medium text-content-primary group-hover:text-indigo-300 transition-colors mb-2'>
                  {technique.name}
                </h3>
