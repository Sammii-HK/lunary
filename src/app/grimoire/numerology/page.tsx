...
export const metadata: Metadata = {
  title:
    'Numerology Guide & Calculators: Life Path, Angel Numbers, Universal Years & Clock Numbers | Lunary',
  description:
    'Learn numerology with Lunary: life path numbers, angel numbers, expression and soul urge numbers, personal and universal year themes, plus clock numbers including mirror hours and double hours. Includes calculators and meaning guides.',
  keywords: [
    'numerology',
  ...
  openGraph: {
    title:
      'Numerology Guide & Calculators: Life Path, Angel Numbers, Universal Years & Clock Numbers',
    description:
      'Explore numerology meanings and calculators for life path, angel numbers, core numbers, personal and universal year themes, plus clock numbers like mirror hours and double hours.',
  ...
  twitter: {
    ...
    title:
      'Numerology Guide & Calculators: Life Path, Angel Numbers, Universal Years & Clock Numbers',
    description:
      'Use Lunary’s numerology calculators for life path, angel numbers, personal and universal year themes, plus mirror hours and double hours.',
  ...
  return (
    <div className='min-h-screen bg-zinc-950 text-zinc-100'>
      ...
      <SEOContentTemplate
        ...
        h1='Numerology'
        description='Need to understand how numerology answers who you are and where you are headed? This guide explains the core number types—angel numbers, life path, expression, soul urge, and universal year—and links to calculators for your personal data.'
        ...
        internalLinksTitle='Explore numerology topics'
        breadcrumbs={[
