...
const sections = (
  <>
    <section className='bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 mb-12'>
    ...
    <section id='what-are-runes' className='mb-16'>
      ...
      <p className='text-zinc-300 leading-relaxed mb-6'>
        ...
        century CE. The word "rune" itself means "secret" or "mystery" in Old
        Germanic languages.
      </p>
      <p className='text-zinc-300 leading-relaxed mb-6'>
      ...
      <div className='bg-zinc-900/50 border border-zinc-800 rounded-xl p-6'>
        <p className='text-zinc-400 text-sm'>
          ...
          When you work with runes, you're connecting with archetypal energies
          that have been recognized for nearly two millennia.
        </p>
      </div>
    </section>
    ...
    <section id='elder-futhark' className='mb-16'>
      ...
      <div className='bg-zinc-900/50 border border-zinc-800 rounded-xl p-6'>
        ...
        <div className='space-y-4 text-zinc-400 text-sm'>
          <div>
            <strong className='text-zinc-200'>Freya's Aett (1-8):</strong> Fehu
            through Wunjo. Deals with material wealth, primal forces, and
            worldly experiences.
          </div>
          <div>
            <strong className='text-zinc-200'>Heimdall's Aett (9-16):</strong>{' '}
            Hagalaz through Sowilo. Deals with challenges, transformation, and
            the forces that test us.
          </div>
          <div>
            <strong className='text-zinc-200'>Tyr's Aett (17-24):</strong> Tiwaz
            through Othala. Deals with the self, society, spiritual matters, and
            legacy.
          </div>
        </div>
      </div>
      ...
      <ol className='space-y-4'>
        <li className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
          ...
          <p className='text-zinc-400 text-sm mt-2'>
            Take a few deep breaths. Clear your mind of distractions. Hold your
            question clearly in your awareness.
          </p>
        </li>
        <li className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
          <span className='text-lunary-primary-400 font-medium'>
        ...
        <li className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
          ...
          <p className='text-zinc-400 text-sm mt-2'>
            Consider each rune's traditional meaning, its position in your
            spread (if using one), and your intuitive response. Let the meanings
            combine into a coherent message.
          </p>
        </li>
        <li className='bg-zinc-900/50 border border-zinc-800 rounded-lg p-5'>
          <span className='text-lunary-primary-400 font-medium'>4. Record</span>
          <p className='text-zinc-400 text-sm mt-2'>
            Write the reading in your Book of Shadows. Note the date, question,
            runes drawn, and your interpretation. Check back later for accuracy.
          </p>
        </li>
      </ol>
    </section>
    ...
    <section id='spreads' className='mb-16'>
      ...
      <div className='space-y-4'>
        ...
        <div className='p-5 rounded-xl border border-zinc-800 bg-zinc-900/30'>
          <h3 className='font-medium text-zinc-100 mb-2'>Three-Rune Spread</h3>
          <p className='text-zinc-400 text-sm'>
    ...
    <section id='making-runes' className='mb-16'>
      ...
      <p className='text-zinc-300 leading-relaxed mb-6'>
        Handmade runes carry your personal energy and often feel more connected.
    ...
    <section id='all-runes' className='mb-16'>
      ...
      <p className='text-zinc-300 leading-relaxed mb-6'>
        Click any rune to explore its full meaning, correspondences, and magical
        applications.
      </p>
      <Runes />
    </section>
  ...
  const heroContent = (
    <div className='text-center mb-8'>
      <p className='text-lg text-zinc-400 max-w-2xl mx-auto'>
        Explore the Elder Futhark—a set of 24 runes that blend language with
        archetype. This guide breaks down every rune, how to read them, and how
        to craft your own set.
      </p>
    </div>
  );
