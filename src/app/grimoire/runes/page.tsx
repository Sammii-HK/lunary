    ...
    <div className='p-4 md:p-8 max-w-4xl mx-auto'>
      ...
      <section id='elder-futhark' className='mb-16'>
        ...
        <div className='bg-surface-elevated/50 border border-stroke-subtle rounded-xl p-6'>
          ...
          <div className='space-y-4 text-content-muted text-sm'>
            <div>
      ...
      <section id='spreads' className='mb-16'>
        ...
        <div className='space-y-4'>
          ...
          <div className='p-5 rounded-xl border border-stroke-subtle bg-surface-elevated/30'>
            <h3 className='font-medium text-content-primary mb-2'>Casting</h3>
            <p className='text-content-muted text-sm'>
      ...
      <section id='making-runes' className='mb-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div className='p-5 rounded-xl border border-stroke-subtle bg-surface-elevated/30'>
            <h3 className='font-medium text-content-primary mb-2'>Wood</h3>
            <p className='text-content-muted text-sm'>
          ...
          <div className='p-5 rounded-xl border border-stroke-subtle bg-surface-elevated/30'>
            <h3 className='font-medium text-content-primary mb-2'>Stones</h3>
            <p className='text-content-muted text-sm'>
          ...
          <div className='p-5 rounded-xl border border-stroke-subtle bg-surface-elevated/30'>
            <h3 className='font-medium text-content-primary mb-2'>Clay</h3>
            <p className='text-content-muted text-sm'>
