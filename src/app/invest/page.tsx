    ...
    <main className='min-h-screen bg-zinc-950 text-zinc-50 flex flex-col'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20 flex-1'>
        ...
        <section className='py-12 md:py-16 lg:py-20 border-b border-zinc-800/50 space-y-6'>
          ...
          <p className='text-base md:text-lg text-zinc-400 leading-relaxed max-w-4xl font-medium text-purple-300'>
          ...
          <p className='text-base md:text-lg text-zinc-300 leading-relaxed max-w-4xl mt-6 font-medium'>
            It is the first <span className='text-purple-300'>symbolic OS</span>{' '}
            powered by AI.
          </p>
        </section>
        ...
        <section className='py-12 md:py-16 lg:py-20 border-b border-zinc-800/50 space-y-6'>
          ...
          <p className='text-base md:text-lg text-zinc-300 leading-relaxed max-w-4xl mt-4 font-medium'>
            This creates an{' '}
            <span className='text-purple-300'>unbeatable moat</span>:
          </p>
          <ol className='space-y-4 text-zinc-300 max-w-4xl mt-6 list-decimal list-inside'>
            <li>
              <span className='font-medium text-purple-300'>Depth</span> — Most
              complete library of symbolic systems
            </li>
            <li>
              <span className='font-medium text-purple-300'>AI</span> — Only
              platform with an astral guide that knows you
            </li>
            <li>
              <span className='font-medium text-purple-300'>SEO</span> — Massive
              evergreen content engine
            </li>
            <li>
              <span className='font-medium text-purple-300'>Shareability</span>{' '}
        ...
        <section className='py-12 md:py-16 lg:py-20 border-b border-zinc-800/50 space-y-6'>
          ...
          <p className='text-base md:text-lg text-zinc-300 leading-relaxed max-w-4xl mt-6 font-medium'>
            Margins are <span className='text-purple-300'>99%+</span>.
          </p>
        </section>
          ...
          <div className='max-w-4xl space-y-4'>
            <div>
              ...
              <a
                ...
                className='text-lg font-medium text-purple-300 hover:text-purple-400 transition-colors'
              >
                sammi@lunary.app
              </a>
            </div>
