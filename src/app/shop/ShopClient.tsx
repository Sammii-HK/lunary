    ...
    <div className='min-h-screen bg-surface-elevated'>
      <div className='container mx-auto px-4 py-8 md:py-12 max-w-7xl'>
        <header className='text-center mb-12'>
          <h1 className='text-2xl md:text-5xl font-light text-content-primary mb-4'>
            Digital Shop
          </h1>
          <p className='text-base md:text-lg text-content-primary/60 max-w-2xl mx-auto'>
        ...
        <div className='mb-8'>
          <div className='relative max-w-md mx-auto'>
            <Search className='absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-content-primary/40 pointer-events-none' />
            <input
              type='text'
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              placeholder='Search packs...'
              className='w-full pl-12 pr-12 py-3 bg-white/5 border border-white/10 rounded-xl text-content-primary placeholder:text-content-primary/40 focus:outline-none focus:border-lunary-primary/50 focus:ring-1 focus:ring-lunary-primary/30 transition-all text-left'
            />
            {searchQuery && (
              <button
                onClick={() => setSearchQuery('')}
                className='absolute right-4 top-1/2 -translate-y-1/2 p-1 rounded-full text-content-primary/40 hover:text-content-primary hover:bg-white/10 transition-all'
          ...
          {searchQuery && (
            <p className='text-center text-sm text-content-primary/50 mt-3'>
        ...
        {displayProducts.length > 0 ? (
          ...
          <div className='text-center py-16'>
            <p className='text-content-primary/50 text-lg'>
        ...
        {totalPages > 1 && !searchQuery && selectedCategory === 'all' && (
          <div className='mt-12'>
            ...
            <p className='text-center text-sm text-content-primary/40 mt-4'>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-white/5 rounded-2xl p-8 max-w-2xl mx-auto border border-white/5'>
            ...
            <p className='text-content-primary/60 text-sm leading-relaxed'>
