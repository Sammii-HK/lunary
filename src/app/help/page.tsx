...
export default function HelpPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'The free plan includes daily moon phases, general tarot card of the day, 2 tarot spreads per month, basic lunar calendar, sun sign horoscope, access to grimoire knowledge, and 1 free AI ritual/reading per week.',
    },
    {
