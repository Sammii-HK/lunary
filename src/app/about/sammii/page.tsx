...
export default function AuthorPage() {
  ...
  return (
    <>
      <div className='min-h-fit bg-surface-base text-content-primary flex flex-col'>
        ...
        <div className='flex-1 max-w-4xl mx-auto px-4 py-12 pb-16'>
          <nav className='flex items-center gap-2 text-sm text-content-muted mb-8'>
            ...
            <span>/</span>
            <span className='text-content-muted'>Sammii</span>
          </nav>

          <div className='grid md:grid-cols-3 gap-8 mb-14'>
            <div>
              <div className='aspect-square relative rounded-2xl overflow-hidden bg-surface-card'>
                <Image
            ...
            <div className='flex flex-wrap gap-4'>
              {socialLinks.map((link) => (
                <a
                  ...
                  className='flex items-center gap-2 px-4 py-2 rounded-lg border border-stroke-subtle bg-surface-elevated/30 hover:border-lunary-primary-600 transition-colors'
                >
                  <span className='text-content-secondary'>{link.name}</span>
