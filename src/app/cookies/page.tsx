        ...
        <div className='prose prose-invert prose-zinc max-w-none space-y-8'>
          ...
          <section>
            ...
            <div className='overflow-x-auto'>
              <table className='w-full text-sm text-content-secondary border border-stroke-subtle rounded-lg'>
            ...
            <h3 className='text-xl font-medium text-content-primary mb-3 mt-8'>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 text-content-secondary space-y-2 mt-2'>
