...
export function BlogList({
  ...
  return (
    <div className='bg-surface-base text-content-primary pb-20'>
      <div className='max-w-7xl mx-auto p-4 md:px-6 lg:px-8'>
        <header className='mb-8 md:mb-12'>
          <h1 className='text-3xl md:text-4xl font-light text-content-primary mb-2 flex items-center gap-3'>
            <BookOpen className='h-8 w-8 md:h-10 md:w-10 text-lunary-primary-400' />
            {isFirstPage ? 'Cosmic Blog' : `Cosmic Blog - Page ${currentPage}`}
          </h1>
          <p className='text-lg md:text-xl text-content-muted'>
        ...
        {isFirstPage && currentWeekData && (
          <article
            className='mb-8 rounded-lg border border-lunary-primary-700 bg-gradient-to-br from-layer-base/20 to-surface-elevated/50 p-6 md:p-8 hover:border-lunary-primary-600 transition-colors'
            itemScope
          ...
          >
            <div className='flex items-start justify-between mb-4'>
              <div className='flex-1'>
                <div className='flex items-center gap-2 mb-2'>
                  <span className='px-3 py-1 text-xs font-medium rounded-full bg-layer-base/20 text-content-brand border border-lunary-primary-700'>
                    This Week
                  </span>
                ...
                <h2
                  className='text-2xl md:text-3xl font-medium text-content-primary mb-2'
                  itemProp='headline'
                >
                  {currentWeekData.title}
                </h2>
                <p
                  className='text-lg text-content-secondary italic mb-4'
            ...
            <p className='text-base text-content-secondary mb-4 leading-relaxed'>
              {currentWeekData.summary}
            </p>
            <div className='flex flex-wrap gap-4 text-sm text-content-muted mb-6'>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl md:text-3xl font-light text-content-primary mb-6'>
            Weekly Archives
          </h2>
          ...
          >
            ...
            {posts.map((post, index) => (
              <Link
                ...
                className='block rounded-lg border border-stroke-subtle/50 bg-surface-elevated/30 p-6 hover:border-lunary-primary-700 hover:bg-surface-elevated/50 transition-all group'
                itemScope
              ...
              >
                ...
                >
                  ...
                  <div className='flex items-start justify-between mb-3'>
                    <div className='flex-1'>
                      <div className='flex items-center gap-2 mb-2'>
                        <span className='px-2.5 py-0.5 text-xs font-medium rounded bg-surface-card/50 text-content-secondary border border-stroke-default/50'>
                      ...
                      <h3
                        className='text-xl md:text-2xl font-medium text-content-primary mb-2 group-hover:text-content-brand transition-colors line-clamp-1'
                        itemProp='headline'
                      >
                        {post.title}
                      </h3>
                      <p
                        className='text-base text-content-secondary italic mb-3 line-clamp-1'
                        itemProp='description'
                      >
                        {post.subtitle}
                      </p>
                  ...
                  <p className='text-sm text-content-muted mb-4 leading-relaxed line-clamp-2'>
                    {post.summary}
                  </p>
                  ...
                  <div className='flex items-center gap-2 text-sm text-lunary-primary-400 group-hover:text-content-brand transition-colors'>
                    Read full forecast
                    <ArrowRight className='h-4 w-4' />
                  </div>
                </div>
          ...
          {totalPages > 1 && (
            <nav
              className='flex items-center justify-center gap-2 mt-8 pt-6 border-t border-stroke-subtle'
