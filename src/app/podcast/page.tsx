    ...
    <>
      ...
      <div className='mx-auto max-w-3xl px-4 py-12'>
        ...
        <nav className='mb-6 text-sm text-content-brand/60'>
          ...
          <span className='text-content-brand/80'>Podcast</span>
        </nav>
        ...
        <header className='mb-10'>
          ...
          <div className='mt-6 flex flex-wrap items-center gap-3'>
            <a
              ...
              className='inline-flex items-center gap-2 rounded-lg border border-lunary-primary-300/20 bg-lunary-primary-300/5 px-4 py-2 text-sm text-content-brand/80 transition-colors hover:border-lunary-primary-300/40 hover:text-content-brand'
            >
        ...
        {episodes.length === 0 ? (
          <div className='rounded-xl border border-lunary-primary-300/20 p-8 text-center'>
            <Headphones className='mx-auto h-12 w-12 text-content-brand/30' />
            <p className='mt-4 text-content-brand/60'>
          ...
          <div className='space-y-6'>
            {episodes.map((episode) => (
              ...
              >
                <div className='mb-2 flex items-center gap-3 text-sm text-content-brand/50'>
                ...
                <p className='mt-2 line-clamp-2 text-content-brand/60'>
                  {episode.description}
                </p>
                ...
                {episode.grimoireSlugs.length > 0 && (
                  <div className='mt-3 flex flex-wrap gap-2'>
                    {episode.grimoireSlugs.slice(0, 3).map((slug) => (
                      <span
                        key={slug}
                        className='rounded-full bg-lunary-primary-300/10 px-2.5 py-0.5 text-xs text-content-brand/60'
                      >
