    ...
    <div className='min-h-screen bg-surface-base text-content-primary flex flex-col pt-16'>
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12'>
        ...
        <div className='prose prose-invert prose-zinc max-w-none space-y-8'>
          ...
          {/* Refund Request Form */}
          <section className='p-6 border border-lunary-primary-700 bg-layer-base/10 rounded-xl'>
            <h2 className='text-2xl font-semibold text-content-primary mb-4'>
              Request a Refund
            </h2>
              ...
              <>
                {!isAuthenticated ? (
                  <div className='text-center py-4'>
                    ...
                    <Link
                      href='/auth'
                      className='inline-flex px-6 py-2 rounded-lg bg-lunary-primary-600 hover:bg-layer-high text-white font-medium transition-colors'
                    >
                      Sign In
                    </Link>
                  </div>
                  ...
                  <div className='space-y-4'>
                    <div>
                      ...
                      <textarea
                        ...
                        className='w-full px-4 py-3 bg-surface-card border border-stroke-default rounded-lg text-content-primary placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-lunary-primary resize-none'
                        rows={3}
                      />
                    </div>
                    ...
                    <button
                      ...
                      disabled={submitting}
                      className='w-full py-3 rounded-lg bg-lunary-primary-600 hover:bg-layer-high disabled:bg-lunary-primary-600/50 text-white font-medium transition-colors flex items-center justify-center gap-2'
                    >
                      {submitting ? (
                        <>
