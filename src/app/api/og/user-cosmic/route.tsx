...
export async function GET(request: NextRequest) {
  ...
  const moonPhase = searchParams.get('moonPhase') || 'New Moon';
  const moonEmoji = searchParams.get('moonEmoji') || '🌑';
  const keyTransit = searchParams.get('transit') || 'Current cosmic energy';
