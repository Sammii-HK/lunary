...
import { generatePaidSubstackPost } from '../../../../../utils/substack/contentFormatter';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const post = generatePaidSubstackPost(weeklyData);
    ...
    console.error('Error generating paid Substack post:', error);
    return NextResponse.json(
      {
        error: 'Failed to generate paid post',
