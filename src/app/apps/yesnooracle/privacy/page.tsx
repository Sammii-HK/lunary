...
export const metadata: Metadata = {
  title: 'Privacy Policy | Yes/No Oracle',
  description:
    'Privacy policy for the Yes/No Oracle iOS app. Learn how your data is protected.',
  robots: 'index, follow',
  alternates: {
    canonical: 'https://lunary.app/apps/yesnooracle/privacy',
  },
};

export default function YesNoOraclePrivacyPage() {
        ...
        <div className='prose prose-invert prose-zinc max-w-none space-y-8'>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 text-content-secondary space-y-2'>
              ...
              <li>
                <strong>Reading History:</strong> Yes/No readings you perform
                and the dates you use the app
              </li>
            </ul>
            ...
            <ul className='list-disc pl-6 text-content-secondary space-y-2'>
              ...
              <li>
                <strong>Usage Analytics:</strong> Which features you use, how
                often, and basic session duration
              </li>
              <li>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 text-content-secondary space-y-2'>
              ...
              <li>
                Understand how features are used to develop better features
              </li>
              <li>
          ...
          <section>
            ...
            <p className='text-content-secondary leading-relaxed'>
              ...
              your Apple devices via CloudKit. We do not have access to
              unencrypted CloudKit data; only you and Apple have access.
            </p>
          </section>
