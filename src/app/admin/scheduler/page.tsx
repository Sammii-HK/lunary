  ...
  const scheduleToday = async () => {
    ...
    try {
      ...
      const socialContent = [
        ...
        ...cosmicContent.highlights.slice(0, 3).map((highlight: string) => `• ${highlight}`),
        '',
      ...
      const postData = {
        accountGroupId: process.env.NEXT_PUBLIC_SUCCULENT_ACCOUNT_GROUP_ID || 'test_group_id',
    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-zinc-900 rounded-lg p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4 text-white">Schedule Posts</h2>
          ...
          <div className="space-y-4 mb-6">
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-1">
                Default: {new Date(getNextMonth() + '-01').toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
              </p>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-zinc-700">
            <h3 className="text-lg font-semibold mb-3 text-zinc-200">🧪 Quick Test</h3>
        ...
        {result && (
          <div className={`rounded-lg p-6 mb-8 ${
            ...
            <h3 className="text-lg font-semibold mb-4 flex items-center">
              {result.success ? '✅' : '❌'} 
              <span className="ml-2">{result.success ? 'Success!' : 'Error'}</span>
            </h3>
            ...
            {result.summary && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-zinc-800 rounded p-3">
                  <div className="text-2xl font-bold text-purple-400">{result.summary.totalPosts}</div>
                  <div className="text-sm text-zinc-400">Total Posts</div>
                </div>
                <div className="bg-zinc-800 rounded p-3">
                  <div className="text-2xl font-bold text-green-400">{result.summary.successful}</div>
                ...
                <div className="bg-zinc-800 rounded p-3">
                  <div className="text-lg font-bold text-blue-400">{result.summary.month}</div>
            ...
            {result.results && result.results.length > 0 && (
              <div>
                <h4 className="font-medium mb-3 text-zinc-200">Post Results:</h4>
            ...
            {(result as any)?.postContent && (
              <div className="mt-6">
                <h4 className="font-medium mb-3 text-zinc-200">📱 Post Content Preview:</h4>
        ...
        <div className="bg-zinc-900 rounded-lg p-6">
          <h3 className="text-lg font-semibold mb-3 text-zinc-200">⚙️ Setup Instructions</h3>
          
          <div className="space-y-3 text-sm text-zinc-400">
            <div>
              <strong className="text-zinc-300">1. Environment Variables:</strong>
...
SUCCULENT_ACCOUNT_GROUP_ID=group_your_group_id_here`}
            ...
            <div>
              <strong className="text-zinc-300">2. Automated Scheduling (Cron):</strong>
              <p className="mt-1">Run this command weekly to schedule the next month:</p>
              <pre className="bg-black/50 p-2 rounded mt-1 text-xs overflow-x-auto">
