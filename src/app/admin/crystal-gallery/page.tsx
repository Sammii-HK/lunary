...
export default function CrystalGalleryPage() {
  ...
  const crystals = [
    { name: 'Amethyst', color: '#9333EA', chakra: 'Crown Chakra', keywords: ['Intuition', 'Clarity', 'Protection'], element: 'Spirit' },
    { name: 'Rose Quartz', color: '#F472B6', chakra: 'Heart Chakra', keywords: ['Love', 'Compassion', 'Peace'], element: 'Water' },
    { name: 'Citrine', color: '#F59E0B', chakra: 'Solar Plexus', keywords: ['Abundance', 'Confidence', 'Joy'], element: 'Fire' },
    { name: 'Black Tourmaline', color: '#1F2937', chakra: 'Root Chakra', keywords: ['Protection', 'Grounding', 'Strength'], element: 'Earth' },
    { name: 'Clear Quartz', color: '#F3F4F6', chakra: 'All Chakras', keywords: ['Amplification', 'Clarity', 'Healing'], element: 'Light' },
    { name: 'Moonstone', color: '#E5E7EB', chakra: 'Sacral Chakra', keywords: ['Intuition', 'Cycles', 'Feminine'], element: 'Moon' },
    { name: 'Carnelian', color: '#EA580C', chakra: 'Sacral Chakra', keywords: ['Creativity', 'Courage', 'Passion'], element: 'Fire' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-zinc-400 mb-6">
            Preview all crystal images with their chakra associations and color variations
          </p>
        </div>
          ...
          {crystals.map((crystal, index) => {
            ...
            const variations = [0, 1, 2].map(dayOffset => {
              ...
              return {
                ...
                label: dayOffset === 0 ? 'Today' : dayOffset === 1 ? 'Tomorrow' : 'Day After',
              ...
              >
                ...
                <div className="p-6 border-b border-zinc-700">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    ></div>
                    <h3 className="text-xl font-bold text-white">{crystal.name}</h3>
                  </div>
                ...
                {/* Daily Variations */}
                <div className="p-4">
                  <h4 className="text-sm font-medium mb-4 text-zinc-300">Daily Background Variations:</h4>
                  <div className="grid grid-cols-3 gap-2">
                    {variations.map((variation) => (
                      <div key={variation.date} className="text-center">
                        ...
                        <div className="text-xs text-zinc-400">{variation.label}</div>
                      </div>
                    ))}
                  </div>
                </div>
