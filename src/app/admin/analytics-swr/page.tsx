...
import { CalendarRange, Download, Settings } from 'lucide-react';
...
export default function AnalyticsPageSWR() {
  ...
  // Fetch analytics with SWR - auto-refreshes based on metric type
  ...
  // Combine SWR data with UI state for compatibility
  const analyticsData = {
    ...swrData,
    startDate,
    endDate,
    ...
    // No manual fetchAnalytics needed - SWR auto-updates!
