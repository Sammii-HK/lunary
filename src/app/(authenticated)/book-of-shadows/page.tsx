...
function DreamCard({ entry }: { entry: DreamEntry }) {
  ...
  return (
    <div className='border-l-2 border-indigo-600 pl-4 py-3'>
      ...
      <p className='text-content-primary text-sm leading-relaxed line-clamp-3'>
        {entry.content}
      </p>
...
function MemoryCard({
  ...
  return (
    <>
      <div className='flex items-start justify-between gap-3 py-2 border-b border-stroke-subtle last:border-0'>
        <div className='flex-1'>
          <span className='text-xs text-lunary-primary-400 uppercase tracking-wide'>
            {CATEGORY_LABELS[memory.category] || memory.category}
          </span>
          <p className='text-content-primary text-sm mt-0.5'>{memory.fact}</p>
        ...
        <button
          ...
          className='p-2 text-content-muted hover:text-lunary-error transition-colors'
        ...
        <div className='px-4 py-4'>
          <div className='flex items-center justify-between mb-4'>
            <div>
              ...
              <p className='text-xs text-content-muted'>Your living journal</p>
            </div>
            <Link
              href='/guide'
              className='flex items-center gap-1.5 bg-surface-card/50 hover:bg-surface-card px-3 py-1.5 rounded-lg text-sm text-content-secondary transition-colors'
            >
      ...
      <div className='px-4 py-3'>
          ...
          <div className='space-y-4'>
            ...
            {journalEntries.length === 0 ? (
              <div className='text-center py-6'>
                <Feather className='w-10 h-10 text-content-muted mx-auto mb-3' />
                <p className='text-content-muted'>No journal entries yet</p>
        ...
        {activeTab === 'ritual' && (
          <div className='space-y-4'>
            ...
            {queryPrompt ? (
              <div className='space-y-3 bg-surface-elevated/50 border border-stroke-subtle rounded-lg p-4'>
            ...
            {ritualEntries.length > 0 && (
              <div className='space-y-3 bg-surface-elevated/40 border border-stroke-subtle rounded-lg p-4'>
                <p className='text-[0.65rem] uppercase tracking-widest text-content-muted'>
                  Ritual reflections
                </p>
                <div className='space-y-2'>
          ...
          <div className='space-y-4'>
            ...
            {dreams.length === 0 ? (
              <div className='text-center py-6'>
                ...
                <p className='text-content-muted'>No dreams recorded yet</p>
                <p className='text-xs text-content-muted mt-2 max-w-xs mx-auto'>
        ...
        {activeTab === 'memories' && (
          <div className='space-y-4'>
            ...
            {memories.length === 0 ? (
              <div className='text-center py-6'>
                <Brain className='w-10 h-10 text-content-muted mx-auto mb-3' />
                <p className='text-content-muted'>No memories yet</p>
                <p className='text-xs text-content-muted mt-1'>
                  Chat with Astral Guide to build your profile
                </p>
              </div>
            ) : (
              <div className='bg-surface-elevated border border-stroke-subtle rounded-lg p-4'>
                {memories.map((memory) => (
                  <MemoryCard
                    key={memory.id}
                    memory={memory}
