...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const additionalGrimoirePages = [
    ...
    {
      url: `${baseUrl}/grimoire/shadow-work`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/grimoire/protection`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    },
    {
      url: `${baseUrl}/grimoire/manifestation`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    },
    {
      url: `${baseUrl}/grimoire/archetypes`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/grimoire/witchcraft-ethics`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    },
  ...
  // Add 2025/2026 events subpages (static pages for specific events)
  const eventSubpages = [
    {
