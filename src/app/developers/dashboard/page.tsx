...
const tierColors: Record<string, string> = {
  free: 'bg-surface-overlay/20 text-content-secondary',
  starter: 'bg-layer-base text-content-brand-secondary',
  developer: 'bg-layer-base/20 text-content-brand',
  business: 'bg-layer-base text-content-brand-accent',
};
  ...
  return (
    <div className='min-h-screen bg-surface-base text-content-primary'>
      <div className='max-w-4xl mx-auto px-4 py-12'>
        <Link
          href='/developers'
          className='inline-flex items-center gap-2 text-sm text-content-muted hover:text-content-primary mb-8'
        >
        ...
        <div className='flex items-center justify-between mb-8'>
          <div>
            <h1 className='text-3xl font-light text-content-primary mb-2'>
              API Dashboard
            </h1>
          ...
          <button
            ...
            className='inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-layer-base/20 hover:bg-layer-base/30 border border-lunary-primary-700 text-content-brand font-medium transition-colors'
          >
        ...
        {error && (
          <div className='mb-6 p-4 rounded-lg bg-layer-deep border border-lunary-error-700 text-lunary-error-300'>
            {error}
        ...
        {newKey && (
          <div className='mb-6 p-4 rounded-lg bg-layer-deep border border-lunary-success-700'>
            ...
            <div className='flex items-center gap-2'>
              <code className='flex-1 bg-surface-card px-3 py-2 rounded text-sm text-content-primary font-mono'>
                {newKey}
              </code>
              <button
        ...
        <div className='space-y-4'>
          {apiKeys.length === 0 ? (
            <div className='text-center py-12 border border-stroke-subtle rounded-lg bg-surface-elevated/50'>
              <Key className='h-12 w-12 text-content-muted mx-auto mb-4' />
              ...
              >
                <div className='flex items-start justify-between mb-4'>
                  <div className='flex items-center gap-3'>
                    <Key className='h-5 w-5 text-content-muted' />
                    <div>
                      <div className='flex items-center gap-2'>
                      ...
                      <code className='text-sm text-content-muted'>
                        {key.keyPrefix}•••••••
                      </code>
                    </div>
                  </div>
                  <div className='flex items-center gap-2'>
                    <button
                      ...
                      className='p-2 rounded hover:bg-surface-card text-content-muted hover:text-content-primary transition-colors'
                    ...
                    <button
                      ...
                      className='p-2 rounded hover:bg-surface-card text-content-muted hover:text-lunary-error transition-colors'
                      title='Delete key'
                    >
                ...
                <div className='grid grid-cols-3 gap-4'>
                  <div className='p-3 rounded bg-surface-card/50'>
        ...
        <div className='mt-12 p-6 rounded-lg border border-stroke-subtle bg-surface-elevated/50'>
            ...
            {(['free', 'starter', 'developer', 'business'] as const).map(
              (tier) => {
                ...
                return (
                  <div
                    key={tier}
                    className='p-4 rounded-lg border border-stroke-default hover:border-lunary-primary-600 transition-colors'
                  >
                    <div
                    ...
                    <div className='text-2xl font-light text-content-primary mb-1'>
                      ${prices[tier]}
