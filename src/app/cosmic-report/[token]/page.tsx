...
export default async function SharedReportPage({ params }: PageProps) {
  ...
  return (
    <div className='w-full max-w-4xl space-y-8 px-4 py-10 text-content-primary'>
      <section className='rounded-3xl border border-white/10 bg-surface-base/50 p-6'>
        ...
        <div className='space-y-4'>
          {report.report_data.sections.map((section: CosmicReportSection) => (
            ...
            >
              ...
              <ul className='mt-3 list-disc space-y-1 pl-6 text-sm text-content-secondary'>
      ...
      <section className='rounded-3xl border border-white/10 bg-surface-base/40 p-6'>
