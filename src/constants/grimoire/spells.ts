...
export interface Spell {
  ...
  category: string;
  subcategory?: string;
  type: 'spell' | 'ritual' | 'charm' | 'potion' | 'candle_magic' | 'herb_magic' | 'crystal_magic' | 'sigil_magic';
...
export const spellDatabase: Spell[] = [
  {
    ...
    purpose: 'Create energetic protection for daily activities and interactions',
    description: 'A simple yet powerful spell to create a protective energy field around yourself for the day ahead',
    fullDescription: 'This foundational protection spell creates an energetic barrier that shields you from negative influences, psychic attacks, and unwanted energies throughout your day. Perfect for daily spiritual hygiene.',
    ...
    variations: [
      {
        ...
        changes: ['Hold black tourmaline while casting', 'Place crystals at cardinal directions'],
        purpose: 'Amplify protective energy and ground the spell'
      },
      {
        name: 'Herbal Version',
        changes: ['Burn sage or rosemary instead of candle', 'Carry protective herbs'],
    ...
    history: 'Protection spells are among the oldest forms of magic, found in every magical tradition worldwide. This modern version combines elements from various protective practices.',
    ...
    troubleshooting: [
      {
        ...
        solution: 'Increase visualization time, use stronger correspondences, or cast during Mars hour'
      },
      {
        issue: 'Feeling drained after casting',
        solution: 'Ground thoroughly, eat something, and ensure you\'re not giving your own energy'
      }
    ]
  }
];
...
export const spellCategories = {
  protection: {
    ...
    subcategories: ['personal-protection', 'home-protection', 'travel-protection', 'psychic-protection']
  },
  love: {
    name: 'Love & Relationships',
    description: 'Magic for self-love, attracting love, and strengthening bonds',
    subcategories: ['self-love', 'attracting-love', 'relationship-healing', 'friendship']
  },
  prosperity: {
    name: 'Prosperity & Abundance',
    description: 'Spells for financial success and material abundance',
    subcategories: ['money-drawing', 'career-success', 'business-prosperity', 'luck']
  },
  healing: {
    name: 'Healing & Wellness',
    description: 'Magical practices for physical, emotional, and spiritual healing',
    subcategories: ['physical-healing', 'emotional-healing', 'spiritual-healing', 'energy-healing']
  },
  cleansing: {
    name: 'Cleansing & Purification',
    description: 'Clearing negative energy from spaces, objects, and self',
    subcategories: ['space-clearing', 'object-cleansing', 'aura-cleansing', 'spiritual-cleansing']
  },
  divination: {
    name: 'Divination & Wisdom',
    description: 'Enhancing psychic abilities and gaining insight',
    subcategories: ['scrying', 'dream-work', 'psychic-enhancement', 'oracle-work']
  },
  manifestation: {
    name: 'Manifestation',
    description: 'Bringing desires and goals into physical reality',
    subcategories: ['goal-manifestation', 'opportunity-creation', 'reality-shaping', 'law-of-attraction']
  },
  banishing: {
    name: 'Banishing & Release',
    description: 'Removing unwanted influences and letting go',
    subcategories: ['habit-breaking', 'entity-removal', 'cord-cutting', 'obstacle-removal']
  }
};
...
export const searchSpells = (query: string): Spell[] => {
  ...
  return spellDatabase.filter(spell => 
    ...
    spell.alternativeNames?.some(name => name.toLowerCase().includes(searchTerm)) ||
