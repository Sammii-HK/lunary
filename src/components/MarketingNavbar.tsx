...
export function MarketingNavbar() {
  ...
  const showBetaBanner =
    ...
    !localStorage.getItem('betaBannerClosed');

  return (
    <nav
      data-global-nav
      className={`fixed left-0 right-0 z-50 border-b-2 border-zinc-800 bg-zinc-950/95 backdrop-blur-md shadow-lg ${!showBetaBanner ? 'top-0' : 'top-[26px] md:top-[32px]'}`}
    >
