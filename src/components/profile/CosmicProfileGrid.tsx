    ...
    <div className='w-full max-w-3xl'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
        <Link
          ...
          className='group rounded-xl border border-lunary-primary-700 bg-gradient-to-br from-layer-deep/60 to-surface-elevated p-4 shadow-lg hover:border-lunary-primary-600 transition-colors'
        >
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-xs text-content-brand-accent/70'>
        ...
        <button
          ...
          className='group rounded-xl border border-stroke-default bg-surface-elevated/70 p-4 shadow-lg hover:border-lunary-primary-700 transition-colors text-left w-full'
        >
          <div className='flex items-center justify-between'>
            <div>
              <h3 className='text-lg font-medium text-content-primary group-hover:text-content-brand-accent transition-colors'>
        ...
        <Link
          ...
          className='group rounded-xl border border-stroke-default bg-surface-elevated/70 p-4 shadow-lg hover:border-lunary-secondary-600 transition-colors'
        >
          <div className='flex items-center justify-between'>
            <div>
              <h3 className='text-lg font-medium text-content-primary group-hover:text-content-brand-secondary transition-colors'>
        ...
        <Link
          ...
          className='group rounded-xl border border-stroke-default bg-surface-elevated/70 p-4 shadow-lg hover:border-lunary-primary-600 transition-colors'
        >
          <div className='flex items-center justify-between'>
            <div>
