...
export function ContextualNudgeSection({
  ...
  return (
    <section className='relative bg-gradient-to-br from-layer-base/40 via-lunary-highlight-900/30 to-layer-base/40 border border-lunary-primary-600/50 rounded-xl p-6 sm:p-8 md:p-10 my-6 md:my-8 text-center overflow-hidden shadow-lg shadow-lunary-primary-900/20'>
      ...
      <div className='relative z-10'>
        <Heading
          as='h2'
          variant='h3'
          className='text-content-secondary mb-4 break-words font-semibold tracking-tight'
        >
          {nudge.headline}
        </Heading>
        <div className='max-w-2xl mx-auto'>
          <p className='text-content-secondary mb-6 leading-relaxed text-sm md:text-base whitespace-pre-line'>
            {nudge.subline}
          </p>
        </div>
