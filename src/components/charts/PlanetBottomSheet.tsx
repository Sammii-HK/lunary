    ...
    <AnimatePresence>
      {planet && (
        <motion.div
          ...
          className='fixed inset-x-0 bottom-0 z-[160] mx-auto max-h-[72dvh] max-w-2xl overflow-y-auto rounded-t-2xl border border-stroke-default bg-surface-elevated px-5 pb-[max(env(safe-area-inset-bottom,0px),2rem)] pt-3 shadow-2xl'
