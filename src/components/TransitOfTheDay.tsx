          ...
          <div className='flex-1 min-w-0'>
            ...
            <div className='locked-preview mb-2'>
              <p className='locked-preview-text text-xs'>
                This transit activates your 7th house of partnerships and relationships. With this planetary energy moving through your chart, you may experience shifts in how you connect with others. The tension between your natal placements and this transit suggests growth through collaboration...
              </p>
            </div>
