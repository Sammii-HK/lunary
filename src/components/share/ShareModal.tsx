...
export function ShareModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className={`bg-surface-elevated border border-stroke-default rounded-xl ${maxWidthClasses[maxWidth]} w-full max-h-[90vh] overflow-y-auto relative transition-all duration-200 opacity-100 scale-100`}
      >
        <button
          onClick={onClose}
