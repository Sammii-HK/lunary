    ...
    <div className='max-w-5xl mx-auto space-y-12 md:space-y-20'>
      ...
      <div className='grid md:grid-cols-2 gap-6 md:gap-10 items-center'>
        <div className='space-y-3'>
          ...
          <p className='text-sm md:text-base text-content-muted mb-3'>
      ...
      <div className='grid md:grid-cols-2 gap-6 md:gap-10 items-center'>
        <div className='order-2 md:order-1 rounded-2xl border border-stroke-subtle/60 bg-surface-elevated/40 p-5 md:p-6'>
          ...
          <div className='space-y-2 mt-4'>
            <div className='text-xs text-content-muted bg-surface-card/50 p-2 rounded'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex justify-start'>
              <div className='max-w-[85%]'>
                <div className='rounded-2xl bg-surface-card/80 border border-stroke-default/40 px-3.5 py-2.5 text-content-primary text-xs'>
