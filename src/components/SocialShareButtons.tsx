  ...
  return (
    <div className='relative'>
      <button
        ...
        className='inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-stroke-subtle/50 bg-surface-elevated/30 hover:bg-surface-elevated/50 text-content-secondary hover:text-content-primary transition-colors text-sm'
      >
      ...
      {isOpen && (
        <div className='absolute top-full left-0 mt-2 p-2 bg-surface-elevated border border-stroke-subtle rounded-lg shadow-lg z-50 min-w-[200px]'>
          <div className='flex flex-col gap-2'>
            {typeof navigator !== 'undefined' &&
              typeof navigator.share === 'function' && (
                <button
                  onClick={handleNativeShare}
                  className='inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-stroke-subtle/50 bg-surface-elevated/30 hover:bg-surface-elevated/50 text-content-secondary hover:text-content-primary transition-colors text-sm text-left'
                >
                  <Share2 className='w-4 h-4' />
                  Share
                </button>
