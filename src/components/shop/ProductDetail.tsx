...
export function ProductDetail({ product }: ProductDetailProps) {
  ...
  return (
    <div className='min-h-screen bg-surface-elevated'>
      ...
      >
        <div className='absolute inset-0 bg-gradient-to-b from-surface-elevated/0 via-surface-elevated/0 to-surface-elevated' />

        {/* Back to Shop Link */}
        <div className='relative z-20 container mx-auto max-w-4xl mb-8'>
          <Link
            href={`/shop${linkSuffix}`}
            className='inline-flex items-center gap-2 text-sm text-content-primary/60 hover:text-content-primary transition-colors'
          >
        ...
        <div className='relative z-10 container mx-auto max-w-4xl text-center'>
          <span className='inline-block px-3 py-1 text-xs font-medium text-content-primary/80 bg-white/10 backdrop-blur-sm rounded-full mb-4'>
            {CATEGORY_LABELS[product.category]}
          </span>
          <h1 className='text-3xl md:text-5xl font-medium text-content-primary mb-4'>
            {product.title}
          </h1>
          <p className='text-xl text-content-primary/80 italic max-w-2xl mx-auto'>
            {product.tagline}
          </p>
        </div>
      </div>
      ...
      <div className='container mx-auto max-w-4xl px-4 -mt-8 relative z-20'>
        <div className='bg-surface-base rounded-2xl border border-white/10 overflow-hidden'>
          <div className='p-8 md:p-10'>
            <p className='text-content-primary/70 text-lg leading-relaxed mb-10'>
              {product.description}
            </p>
            ...
            <div className='mb-10'>
              ...
              <ul className='space-y-3'>
                {product.whatInside.map((item, index) => (
                  <li
                    key={index}
                    className='flex items-start gap-3 text-content-primary/60'
                  >
            ...
            <div className='mb-10 bg-surface-elevated/50 border border-stroke-subtle rounded-xl p-6'>
              <h2 className='text-sm font-medium text-content-primary/50 uppercase tracking-wider mb-5'>
                Questions?
              </h2>
                ...
                <div>
                  ...
                  <p className='text-sm text-content-muted'>
                    ...
                    <a
                      ...
                      className='text-lunary-primary hover:text-content-primary transition-colors'
                    >
                      hello@lunary.app
                    </a>
                    .
            ...
            <div className='border-t border-white/10 pt-8 mt-8'>
              <div className='flex flex-col sm:flex-row items-center justify-between gap-4'>
                <div>
                  ...
                  <p className='text-content-primary/40 text-sm mt-1'>
                    {product.category === 'notion_template'
                ...
                <Button
                  ...
                  className='w-full sm:w-auto px-8 py-4 hover:shadow-[0_0_20px_#7B7BE880,0_0_40px_#7B7BE840] text-content-primary font-medium transition-all duration-300 disabled:opacity-50'
                  style={{ background: product.gradient }}
                  size='lg'
                >
                  {isPurchasing ? (
