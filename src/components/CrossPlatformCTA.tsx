...
export function CrossPlatformCTA({
  ...
  if (variant === 'app') {
    return (
      <div
        className={`rounded-lg border border-lunary-primary/20 bg-gradient-to-br from-layer-base/20 to-surface-elevated/50 p-6 ${className}`}
      >
  ...
  if (variant === 'substack') {
    return (
      <div
        className={`rounded-lg border border-lunary-secondary-800 bg-gradient-to-br from-lunary-secondary-900/20 to-surface-elevated/50 p-6 ${className}`}
      >
        <div className='flex items-start gap-4'>
  ...
  if (variant === 'blog') {
    return (
      <div
        className={`rounded-lg border border-stroke-default/50 bg-surface-elevated/30 p-6 ${className}`}
      >
        <div className='flex items-start gap-4'>
          <BookOpen className='w-6 h-6 text-content-muted flex-shrink-0 mt-1' />
          <div className='flex-1'>
            <h3 className='text-lg font-semibold text-content-primary mb-2'>
