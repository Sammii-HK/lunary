...
export const CrystalPreview = () => {
  ...
  if (!crystalName && authStatus.loading && authStatus.isAuthenticated) {
    return (
      <div className='py-3 px-4 bg-surface-elevated border border-stroke-subtle/50 rounded-md animate-pulse min-h-16'>
  ...
  if (!crystalName) {
    return (
      <div
        ...
        className='block py-3 px-4 bg-surface-elevated border border-stroke-subtle/50 rounded-md w-full h-full hover:border-lunary-primary-700/50 transition-colors group min-h-16'
      >
  ...
  return (
    <>
      <div
        ...
        className='w-full h-full py-3 px-4 bg-surface-elevated border border-stroke-subtle/50 rounded-md hover:border-lunary-primary-700/50 transition-colors group text-left min-h-16'
