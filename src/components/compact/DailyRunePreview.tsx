  ...
  return (
    <>
      <div
        ...
        className='w-full h-full py-3 px-4 bg-surface-elevated border border-stroke-subtle/50 rounded-md hover:border-lunary-primary-700/50 transition-colors group text-left min-h-16 cursor-pointer'
              ...
              <>
                <div className='relative mt-2'>
                  ...
                  <span
                    ...
                    className='absolute top-0 right-0 inline-flex items-center gap-1 text-[10px] bg-layer-base/80 border border-lunary-primary-700/50 px-2 py-0.5 rounded text-content-brand cursor-pointer hover:bg-layer-raised/80 transition-colors'
                  >
                ...
                <span
                  ...
                  className='flex items-center gap-1.5 text-xs text-content-secondary hover:text-content-secondary transition-colors bg-none border-none p-0 cursor-pointer'
                >
                  {ctaCopy.rune}
                </span>
              </>
