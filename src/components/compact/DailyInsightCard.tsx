          ...
          <div className='flex-1 min-w-0'>
            ...
            <div className='locked-preview mb-2'>
              <p className='locked-preview-text text-xs'>
                Moon First Quarter in your 7th house brings focus to partnerships and collaboration. Meanwhile, Neptune enters Aries in your 6th house, inspiring you to reimagine your daily routines. This connects to your theme: Creative Emergence. Your natal placements suggest this is a pivotal moment for transformation...
              </p>
            </div>
