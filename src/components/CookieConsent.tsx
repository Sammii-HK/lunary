...
export function CookieConsent() {
  ...
  return (
    <div className='fixed bottom-20 right-4 z-50 max-w-sm'>
      <div>
        <div className='rounded-xl border border-stroke-subtle bg-surface-elevated/95 backdrop-blur-sm shadow-xl p-4'>
          {!showCustomize ? (
            <>
              <div className='mb-3'>
                <p className='text-xs text-content-muted leading-relaxed'>
                  ...
                  <Link
                    href='/cookies'
                    className='text-lunary-accent hover:text-content-brand-accent underline'
                  >
              ...
              <div className='flex gap-2'>
                ...
                <button
                  ...
                  className='flex-1 rounded-lg bg-surface-card hover:bg-surface-overlay text-content-primary text-xs font-medium py-2 px-3 transition-colors'
                >
                  Decline
                </button>
                <button
                  onClick={() => setShowCustomize(true)}
                  className='rounded-lg border border-stroke-default hover:border-stroke-strong text-content-muted text-xs py-2 px-2 transition-colors'
                >
                  ⚙️
                </button>
              </div>
            ...
            <>
              <div className='space-y-3 mb-3'>
                <div className='flex items-center justify-between gap-3 p-2 rounded-lg bg-surface-card/50'>
                  <p className='text-xs text-content-primary'>Essential</p>
                ...
                <div className='flex items-center justify-between gap-3 p-2 rounded-lg bg-surface-card/50'>
                  <p className='text-xs text-content-primary'>Analytics</p>
                  <button
                    ...
                    <div
                      className={`w-8 h-5 rounded-full flex items-center px-0.5 transition-colors ${
                        analyticsEnabled
                          ...
                          : 'bg-surface-overlay justify-start'
                      }`}
                    >
                      <div className='w-3.5 h-3.5 rounded-full bg-white' />
                    </div>
              ...
              <div className='flex gap-2'>
                <button
                  ...
                  className='flex-1 rounded-lg border border-stroke-default text-content-secondary text-xs py-2 px-3 transition-colors'
                >
                  Back
                </button>
                <button
