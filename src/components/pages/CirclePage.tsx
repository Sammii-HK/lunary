    ...
    <div className='min-h-fit bg-surface-base text-content-primary'>
      ...
      <section className='py-16 md:py-24 px-4 md:px-6'>
        <div className='max-w-4xl mx-auto text-center space-y-6'>
          <div className='inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-layer-base/30 border border-lunary-primary-700/30 text-content-brand text-xs'>
          ...
          <Heading as='h1' variant='h1'>
            Astrology is Better
            <br />
            <span className='text-content-brand'>With Friends</span>
          </Heading>
          <p className='text-base md:text-lg text-content-muted leading-relaxed max-w-2xl mx-auto'>
      ...
      {/* Three Pillars */}
      <section className='py-16 md:py-20 px-4 md:px-6 border-t border-stroke-subtle/50'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid md:grid-cols-2 gap-6 md:gap-8'>
            {/* Pillar 1: Synastry */}
            <div className='rounded-2xl border border-stroke-subtle/60 bg-surface-elevated/40 p-6 md:p-8 space-y-4'>
              <div className='flex items-center gap-2 align-middle'>
                <div className='p-3 rounded-full bg-layer-base/50 text-content-brand w-fit'>
                  <Heart className='w-6 h-6' />
                </div>
                <Heading
                  as='h3'
                  variant='h3'
                  className='mb-0 ml-2 text-content-brand'
                >
              ...
              <div className='pt-4 border-t border-stroke-subtle/50'>
            ...
            {/* Pillar 2: Best Times */}
            <div className='rounded-2xl border border-lunary-primary-700/30 bg-layer-base/10 p-6 md:p-8 space-y-4 relative overflow-hidden'>
              <div className='absolute top-4 right-4 px-2 py-1 rounded-full bg-lunary-primary-600/20 text-content-brand text-[10px] uppercase tracking-wide'>
                Pro
              </div>
              <div className='flex items-center gap-2 align-middle'>
                <div className='p-3 rounded-full bg-layer-base/50 text-content-brand w-fit'>
      ...
      {/* How It Works */}
      <section className='py-16 md:py-20 px-4 md:px-6 bg-surface-elevated/30'>
      ...
      <section className='py-16 md:py-20 px-4 md:px-6 border-t border-stroke-subtle/50'>
        <div className='max-w-5xl mx-auto'>
          <div className='grid md:grid-cols-2 gap-8 md:gap-12 items-center'>
            ...
            {/* Example Card */}
            <div className='rounded-2xl border border-stroke-subtle/60 bg-surface-elevated/60 p-6 space-y-4'>
              <div className='flex items-center gap-3'>
                <div className='w-10 h-10 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center text-content-primary font-medium'>
                  L
                </div>
                <div>
              ...
              <div className='space-y-3 pt-2'>
                <div className='rounded-lg bg-surface-card/50 p-3'>
                  ...
                  <p className='text-sm text-content-secondary'>Feb 17-24</p>
                  <p className='text-xs text-content-muted'>
                ...
                <div className='rounded-lg bg-surface-card/50 p-3'>
                  ...
                  <p className='text-sm text-content-secondary'>Feb 25-28</p>
                  <p className='text-xs text-content-muted'>
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            ...
            <div className='rounded-xl border border-stroke-subtle/60 bg-surface-elevated/40 p-6 space-y-4'>
              <Heading as='h3' variant='h2' className='text-content-primary'>
                Free
              </Heading>
              <ul className='space-y-2 text-sm text-content-muted'>
                <li className='flex items-start gap-2'>
                  <Check className='w-4 h-4 text-content-muted mt-0.5' />
            ...
            {/* Lunary+ */}
            <div className='rounded-xl border border-lunary-primary-700/50 bg-layer-base/20 p-6 space-y-4'>
              <Heading as='h3' variant='h2' className='text-content-brand'>
                Lunary+
              </Heading>
              <ul className='space-y-2 text-sm text-content-muted'>
                <li className='flex items-start gap-2'>
            ...
            {/* Pro */}
            <div className='rounded-xl border border-lunary-accent-700/50 bg-layer-base/10 p-6 space-y-4'>
              <Heading
                as='h3'
                variant='h2'
      ...
      {/* Final CTA */}
      <section className='py-16 md:py-24 px-4 md:px-6 border-t border-stroke-subtle/50'>
  ...
  return (
    <div className='flex gap-4 md:gap-6'>
      <div className='flex flex-col items-center'>
        <div className='w-10 h-10 rounded-full bg-layer-base/30 border border-lunary-primary-700/30 flex items-center justify-center text-content-brand'>
          {icon}
        </div>
        <div className='flex-1 w-px bg-surface-card/50 mt-2' />
      </div>
      <div className='pb-8'>
