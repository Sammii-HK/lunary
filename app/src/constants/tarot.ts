...
export const tarotSuits = {
  ...
  swords: {
    ...
    mysticalProperties:
      'Deals with the realm of the mind and intellect. Associated with conflict, moral integrity, and decisions. Represents challenges and changes in one’s thoughts or beliefs.',
  },
  pentacles: {
    name: 'Pentacles',
    element: 'Earth',
