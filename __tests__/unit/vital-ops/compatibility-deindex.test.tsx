 ...
 *
 * Fix belongs in app logic (normalise the JSON keys, or canonicalise on lookup),
 * so per the test-only scope this is left .skip until the regression is fixed.
 */
describe.skip('VITAL #13 BUG: non-alphabetical curated keys are unreachable via canonical slug', () => {
